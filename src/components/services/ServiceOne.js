...
const ServiceOne = ({ bgDark, services_head, services }) => {
  useEffect(() => {
  ...
  return (
    ...
    >
      <div className="container">
        <div className="row">
          <div className="col-12 justify-content-center" data-aos="fade-right">
            {bgDark ? (
              <SectionTitle
                subtitle="Services"
                title={services_head?.data?.attributes?.title}
                description={services_head?.data?.attributes?.description}
                centerAlign
                dark
              />
            ) : (
